const PARSER_MESSAGE = {
  ...
  ILLEGAL_IMPORT_EXPORT_LEVEL: "'import' and 'export' may only appear at the top level",
  ILLEGAL_IMPORT_EXPORT_OUTSIDE_MODULE: "'import' and 'export' may only be used in ES modules",
  ILLEGAL_IMPORT_META_OUTSIDE_MODULE: "Cannot use 'import.meta' outside a module",
  ILLEGAL_IMPORT_META_PROPERTY: "The only valid meta property for 'import' is 'import.meta'",
