...
if (rootModule.filename === null &&
  ...
  const compile = __non_webpack_require__("./caching-compiler.js").compile
  const Runtime = __non_webpack_require__("./runtime.js")
  const utils = __non_webpack_require__("./utils.js")
  const vm = __non_webpack_require__("vm")
  const Wrapper = __non_webpack_require__("./wrapper.js")
