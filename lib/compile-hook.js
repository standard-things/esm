...
const wrapperName = utils.encodeIdent("wrapper")
...
function extWrap(func, pkgInfo, mod, filePath) {
  ...
  if (isESM) {
    ...
    if (! config.cjs) {
      ...
      const applyWrapper = Function.prototype.apply = function (thisArg, args) {
        Function.prototype.call = call
        if (this.name === wrapperName) {
          Function.prototype.apply = apply
          return this.call(void 0, args[2])
        }
        const result = apply.call(this, thisArg, args)
        Function.prototype.call = callWrapper
        return result
      }

      const call = Function.prototype.call
      const callWrapper = Function.prototype.call = function (thisArg) {
        Function.prototype.apply = apply
        if (this.name === wrapperName) {
          Function.prototype.call = call
          return this.call(void 0, arguments[3])
        }
      ...
      Module.wrap = (script) => {
        Module.wrap = wrap
        return '"use strict";(function ' + wrapperName +
               "(" + moduleAlias + "){" + script + "\n})"
      }
    }
