...
function moduleExport(getterPairs, constant) {
...
function moduleImport(id) {
  return new Promise((resolve, reject) => {
    ...
    try {
      exported = this.require(utils.resolvePath(id, this))
    } catch (e) {
      setImmediate(() => reject(e))
      return
    }

    this.watch(exported, [["*", (value) => ns = value]])
...
Rp.runSetters = runSetters

function watch(exported, setterPairs) {
  utils.setESModule(this.exports)
  Entry.getOrCreate(this.exports, this)
