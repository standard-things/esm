...
exports.enable = function (Module) {
  ...
  // export statement.
  Mp.export = function (getters, value) {
    var module = this;
    setESModule(module);
    ...
    if (typeof getters === "string") {
      // All getters will be rerun by either entry.runModuleSetters or
      // entry.runModuleGetters below, so it doesn't actually matter what
      // name was passed as the first argument to module.export.

    } else if (utils.isPlainObject(getters)) {
