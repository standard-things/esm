...
function has(object, key) {
  return isObjectLike(object) && hasOwn.call(object, key)
}
...
function isESModule(exported) {
  return has(exported, esSymKey) && !! exported[esSymKey]
}

exports.isESModule = isESModule

function isESModuleLike(exported) {
  return isESModule(exported) ||
    (has(exported, esStrKey) && !! exported[esStrKey])
}
